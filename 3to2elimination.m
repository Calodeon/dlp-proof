...
P_D := add(P,D);
u := reduce_fraction([P_D[1],P_D[3]]); // u := x(P+D)
...
// co,mo := CoefficientsAndMonomials(det);
// det0 := &+[Evaluate(co[i], [A,B,xQ,yQ,x1,0,z1]) * mo[i] : i in [1..#co]];
// l1 := lead(det0);
// l2 := lead(det0 - l1);
// l3 := lead(det0 - l1 - l2);
// l1,l2,l3;
...
// co,mo := CoefficientsAndMonomials(det);
// det0 := &+[Evaluate(co[i], [-3*x1^2,B,xQ,yQ,x1,0,z1]) * mo[i] : i in [1..#co]];
// l1 := lead(det0);
// l2 := lead(det0 - l1);
// l3 := lead(det0 - l1 - l2);
// l1,l2,l3;
...
// co,mo := CoefficientsAndMonomials(det);
// det0 := &+[Evaluate(co[i], [-3*x1^2,2*x1^3,xQ,yQ,x1,0,z1]) * mo[i] : i in [1..#co]];
// l1 := lead(det0);
// l2 := lead(det0 - l1);
// l3 := lead(det0 - l1 - l2);
// l1,l2,l3;
